...
Este projeto foi desenvolvido como um caso de estudo prático para o consumo de APIs com "FETCH" no ecossistema do desenvolvimento frontend, com foco em manipulação de requisições assíncronas e atualização dinâmica da interface de usuário (DOM).
